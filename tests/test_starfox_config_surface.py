...
class StarFoxConfigSurfaceTests(unittest.TestCase):
    ...
    def test_enhanced_renderer_is_explicitly_opt_in(self):
        ...
        # Arwing64 explicitly opts into source latching for its Authentic
        # post-pass. Neither feature enabled must still use the stock path.
        self.assertIn("!g_config.enhanced_renderer && !arwing64_wants_enhanced_frame()", renderer_c)
        self.assertIn("!native_shape_overlay_enabled()", renderer_c)
        self.assertIn("!g_config.enhanced_renderer && !arwing64_wants_enhanced_frame()", main_c)
        ...
        # Scene/fade behavior is exercised by test_starfox_presentation.py.
        self.assertIn("StarFoxPresentationIsWideWorld", renderer_c)
        self.assertIn("StarFoxPresentationPublishedBg1", native_cpp)
        self.assertIn("StarFoxPresentationCaptureLine", rtl_c)
        ...
        self.assertIn("kRamPlayerFlyMode = 0x14da", renderer_c)
        self.assertIn("kRamWhichFriend = 0x189a", renderer_c)
        self.assertIn("kRamFriendsMsg = 0x189b", renderer_c)
        self.assertIn("kRamMsgCount1 = 0x189d", renderer_c)
        self.assertIn("kRamMsgCount2 = 0x189e", renderer_c)
        self.assertIn("kRamShieldUp = 0x16cd", renderer_c)
        self.assertIn("kRamShadowHeight = 0x1957", renderer_c)
        self.assertIn("kGsuFacePtr = 0x0018", renderer_c)
        self.assertIn("kGsuPlayerFlyMode = 0x01a0", renderer_c)
        self.assertIn("kGsuShadowHeight = 0x0220", renderer_c)
        ...
        self.assertIn("kRamHudRotation = 0x14c3", renderer_c)
        self.assertIn("kGsuHudColour = 0x2b24", renderer_c)
        self.assertIn("kGsuHudDamageFlags = 0x2b26", renderer_c)
        ...
        self.assertIn("kGsuDamage = 0x01b8", renderer_c)
        self.assertIn("kGsuBoostAnim = 0x01bc", renderer_c)
        self.assertNotIn("kGsuShieldUp", renderer_c)
        self.assertIn("kGsuMeters = 0x021c", renderer_c)
