...
At 120 FPS, simulation and rendering run between evenly spaced display slots,
with the retained picture displayed halfway between new pictures. Absolute
deadlines prevent rendering time from bunching both presentations together.
Software rendering and rewind capture use CPU
